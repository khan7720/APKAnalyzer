  ...
  <body>
    ...
    <div class="container">
      ...
      <div id="loading" style="height: 500px; width:500px; margin:0 auto;display: none;"></div>   
      		<div id="whole">
        <h1 class="text-muted">APK上传</h1>
        <br>
        <br>
        <div class="alert alert-warning" role="alert"> ${fileName} ${message} ${formatError}<span class="label label-info">结果</span></div> 
        <br>
        <br>
        <p class="lead">                               
				<a href="/TestProject/CoreAnalyzeServlet?filename=${fileName}"><input id="hide" type="submit" value="开始分析" class="btn btn-lg btn-lg btn-success"></a>
      			 <script>
						function my(id){
